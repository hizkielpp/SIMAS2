...
class Surat extends Controller
{
    ...
    public function disposisi(Request $request)
    {
        if(isset($_GET['id'])){                
            ...
            return redirect()->route('suratMasuk')->with('failed','gagal menampilkan lembar disposisi surat masuk'.$e);
            }
    ...
    {   
        ...
        if($suratMasuk)
        {
            return view('surat-masuk')->with(['suratMasuk'=>$suratMasuk,'sifat'=>$sifat,'hal'=>$hal,'tujuan'=>$tujuan]);
        }else
        {
    ...
    public function indexSA(Request $request)
    {
        ...
        if($suratAntidatir)
        {
            return view('surat-antidatir')->with(['suratAntidatir'=>$suratAntidatir,'sifat'=>$sifat,'hal'=>$hal,'unit'=>$unit,'tujuan'=>$tujuan]);
        }else
        {
    ...
    public function indexSK(Request $request)
    {
        ...
        if($suratKeluar)
        {
            return view('surat-keluar')->with(['tujuan'=>$tujuan,'suratKeluar'=>$suratKeluar,'sifat'=>$sifat,'hal'=>$hal,'unit'=>$unit]);
        }else
        {
