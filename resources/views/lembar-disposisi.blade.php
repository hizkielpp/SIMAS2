...
<html lang="en">
  ...
  <body>
    <div class="disposisi py-4 mx-auto container">
          ...
          <form action="">
            <div class="d-flex align-items-start mb-1">
              ...
              <div class="disposisi__info-body ms-2">
                <h4>{{ date('d ', strtotime($surat->created_at)) }}{{ convertToBulan(date('F', strtotime($surat->created_at))) }}{{ date(' Y ', strtotime($surat->created_at)) }}</h4>
              </div>
            </div>
            <div class="d-flex align-items-start mb-1">
              <div class="disposisi__info-title d-flex justify-content-between">
              ...
              <div class="disposisi__info-body ms-2">
                <h4>{{ date('d ', strtotime($surat->tanggalPengajuan)) }}{{ convertToBulan(date('F', strtotime($surat->tanggalPengajuan))) }}{{ date(' Y ', strtotime($surat->tanggalPengajuan)) }}</h4>
              </div>
            </div>
            <div class="d-flex align-items-start mb-1">
              <div class="disposisi__info-title d-flex justify-content-between">
      ...
      <div class="d-flex justify-content-end mt-5" id="cetak">
