              ...
              <div class="row">
                <div class="col-lg-6 col-12">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan nomor surat" id="noSurat" name="nomorSurat" aria-describedby="emailHelp" />
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="asalSurat" name="asalSurat" placeholder="Contoh : Ketua Departemen Kedokteran" aria-describedby="emailHelp" />
                  </div>
                  <div class="mb-3">
                ...
                <div class="col-lg-6 col-12">
                  ...
                  <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label black fw-semibold">Perihal</label>
            ...
            <form id="formEdit" enctype="multipart/form-data" method="POST" action="{{ route('editSM') }}">
              ...
              <div class="row">
                <div class="col-lg-6 col-12">
                  ...
                  <div class="mb-3">
                    <label for="penerima" class="form-label black fw-semibold">Penerima</label>
                    <select class="form-select" aria-label="Default select example" name="tujuanSurat" id="tujuanSuratE">
                      <option selected>
                        -- Pilih salah satu --
                      </option>
                      @foreach ($tujuan as $k => $v)
                  ...
                  <div class="mb-3">
                    <label for="asalSurat" class="form-label black fw-semibold">Asal Surat</label>
                    <input type="text" class="form-control" id="asalSuratE" name="asalSurat" placeholder="Contoh : Ketua Departemen Kedokteran" aria-describedby="emailHelp" />
                  </div>
                  <div class="mb-3">
                    <label for="kodeHal" class="form-label black fw-semibold">Kode Hal</label>
                ...
                <div class="col-lg-6 col-12">
                  <div class="mb-3">
                    <label for="penerima" class="form-label black fw-semibold">Sifat</label>
                    <select class="form-select" id="sifatSuratE" aria-label="Default select example" name="sifatSurat">
                      <option selected>
                        -- Pilih salah satu --
                      </option>
                      @foreach ($sifat as $k => $v)
          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-center">
                <button type="button" data-bs-toggle="modal" data-bs-target="#editSuratMasuk" class="myicon blue d-flex align-items-center justify-content-center me-2 passId" data-id="{{ $v->id }}">
