                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="perihal" class="form-control" style="height: 13.9rem" id="exampleFormControlTextarea1"
                                                rows="8" placeholder="Contoh : Permohonan perijinan penelitian" required></textarea>
                                            <div class="invalid-feedback">
                            ...
                            <form id="formEdit" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="alert alert-primary gap-1 d-flex align-items-start" role="alert">
                                    ...
                                    <div>
                                        ...
                                        <h5 class="mt-1 fw-normal" style="line-height: 1.5">
                                            Surat ini dibuat oleh : <span id="created_by"></span> pada <span
                                                id="created_at"></span>
                                        </h5>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control perihal" id="perihalE" name="perihal" rows="1"
                                                placeholder="Contoh : Permohonan perijinan penelitian" style="min-height: unset"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <tbody>
                        @foreach ($suratAntidatir as $k => $v)
                            <tr>
                                ...
                                <td>
                                    {{ date('d ', strtotime($v->tanggalPengesahan)) }}{{ convertToBulan(date('F', strtotime($v->tanggalPengesahan))) }}{{ date(' Y', strtotime($v->tanggalPengesahan)) }}
                                </td>
                                <td>{{ $v->perihal }}</td>
                                <td>{{ $v->tujuanSurat }}</td>
                                <td>
