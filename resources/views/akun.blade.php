          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content p-3">
              ...
              <div class="modal-body">
                <form id="formRegistrasi" enctype="multipart/form-data" method="POST" action="{{ route('inputAkun') }}">
                @csrf  
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <div class="d-flex">
                          ...
                          />
                          <i class="far fa-eye-slash" id="passIcon" onclick="showPass()" style="margin-left: -30px;margin-top:8px; cursor: pointer;"></i>
                        </div>
                      </div>
                  ...
                  >
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content p-3">
                        ...
                        <div class="modal-body">
                          <form id="formEdit" enctype="multipart/form-data" method="POST" action="{{ route('editAkun') }}">
                            @csrf  
                              <div class="row">
                                <div class="col-lg-12">
                                  <div class="mb-3">
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        aria-describedby="emailHelp"
                                      />
                                      <i class="far fa-eye-slash" id="passIconE" onclick="showPassE()" style="margin-left: -30px;margin-top:8px; cursor: pointer;"></i>
                                    </div>
                                  </div>
                                  <div class="mb-3">
                                    <label
                                    ...
                                    <div class="d-flex">
                                        ...
                                        aria-describedby="emailHelp"
                                      />
                                      <i class="far fa-eye-slash" id="passIconEC" onclick="showPassEC()" style="margin-left: -30px;margin-top:8px; cursor: pointer;"></i>
                                    </div>
                                  </div>
                                </div>
                              </div>
