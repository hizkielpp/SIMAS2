...
<section class="content">
    ...
    <div class="d-flex gap-3 flex-wrap flex-xl-nowrap dashboard">
        ...
        <div class="card p-4 mb-md-0 keterangan position-relative"
            style="background-color: #2F5596; flex: 1 1 30%; height: fit-content;">
            ...
            <h5 class="fw-semibold text-white mb-2"><i class="fa-solid fa-circle-info me-2"></i>Info</h5>
            <h5 class="fw-normal light mb-3" style="line-height: 1.5">
                Pedoman
                Tata Naskah Dinas di Lingkungan Universitas Diponegoro
            </h5>
